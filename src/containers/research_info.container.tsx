...
const ResearchInfoContainer = ({}: props) => {
  return (
    <div className="absolute flex flex-auto flex-col overflow-y-auto bg-blue-themeDark/90 text-whiteT rounded-md p-4">
      {/* CLOSE */}
      <div className="flex flex-col place-items-end">
        <button>
          <CrossSVG classname="fill-current h-6" title={false} />{" "}
        </button>
      </div>
      ...
      <div className="flex flex-row w-full p-2">
        <div className="w-7/12">
          ...
          <div className="w-full p-2 border-2 border-blackT">
            <div className="">
              <GoogleMap />
            </div>
          </div>
      ...
      <div className="flex flex-row self-end w-8/12 p-2">
